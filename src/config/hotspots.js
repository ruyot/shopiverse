...
const defaultHotspots = {
    ...
    storeP1Right: [
        { id: 'item-r1-1', x: 30, y: 35, label: 'Product 1', title: 'Product 1', images: [] },
    ...
    storeP2Left: [
        { id: 'item-l2-1', x: 21, y: 45, label: 'Product 1', title: 'Product 1', images: [] },
    ...
    storeP2Right: [
        { id: 'item-r2-1', x: 39, y: 50, label: 'Product 1', title: 'Product 1', images: [] },
